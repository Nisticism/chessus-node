        ...
        for (const piece of piecesToInsert) {
          if (piece.piece_id && !piece._occupied && !piece._anchorKey) {
            ...
            await dbHelpers.addPieceToGameType(
              ...
              piece.is_neutral
                ? (piece.neutral_image_index != null && piece.neutral_image_index >= 0 ? Number(piece.neutral_image_index) : null)
    ...
    sendWelcomeEmail(email, username)
      .then(result => {
        if (result.success) {
          ...
          console.log(`?? Welcome email not sent: ${result.message}`);
        }
      })
      .catch(err => {
  ...
  try {
    ...
    const pieceSql = `
      INSERT INTO pieces (
        ...
        up_left_movement_change_available_for, up_movement_change_available_for, up_right_movement_change_available_for, right_movement_change_available_for,
        down_right_movement_change_available_for, down_movement_change_available_for, down_left_movement_change_available_for, left_movement_change_available_for,
        repeating_movement_change, require_empty_via_movement,
        directional_capture_change,
        up_left_capture_change, up_capture_change, up_right_capture_change, right_capture_change,
        down_right_capture_change, down_capture_change, down_left_capture_change, left_capture_change,
        up_left_capture_change_exact, up_capture_change_exact, up_right_capture_change_exact, right_capture_change_exact,
        down_right_capture_change_exact, down_capture_change_exact, down_left_capture_change_exact, left_capture_change_exact,
        up_left_capture_change_available_for, up_capture_change_available_for, up_right_capture_change_available_for, right_capture_change_available_for,
        down_right_capture_change_available_for, down_capture_change_available_for, down_left_capture_change_available_for, left_capture_change_available_for,
        repeating_capture_change, require_empty_via_capture,
        require_direction_change, require_direction_change_capture,
        image_sources_json,
        created_at
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ...
    const pieceValues = [
      ...
      parseBooleanField(pieceData.directional_movement_change),
      parseInt(pieceData.up_left_movement_change) || 0,
      parseInt(pieceData.up_movement_change) || 0,
      parseInt(pieceData.up_right_movement_change) || 0,
      parseInt(pieceData.right_movement_change) || 0,
      parseInt(pieceData.down_right_movement_change) || 0,
      parseInt(pieceData.down_movement_change) || 0,
      parseInt(pieceData.down_left_movement_change) || 0,
      parseInt(pieceData.left_movement_change) || 0,
      pieceData.up_left_movement_change_exact === 'true' || pieceData.up_left_movement_change_exact === true,
      pieceData.up_movement_change_exact === 'true' || pieceData.up_movement_change_exact === true,
      pieceData.up_right_movement_change_exact === 'true' || pieceData.up_right_movement_change_exact === true,
      pieceData.right_movement_change_exact === 'true' || pieceData.right_movement_change_exact === true,
      pieceData.down_right_movement_change_exact === 'true' || pieceData.down_right_movement_change_exact === true,
      pieceData.down_movement_change_exact === 'true' || pieceData.down_movement_change_exact === true,
      pieceData.down_left_movement_change_exact === 'true' || pieceData.down_left_movement_change_exact === true,
      pieceData.left_movement_change_exact === 'true' || pieceData.left_movement_change_exact === true,
      parseInt(pieceData.up_left_movement_change_available_for) || null,
      parseInt(pieceData.up_movement_change_available_for) || null,
      parseInt(pieceData.up_right_movement_change_available_for) || null,
      parseInt(pieceData.right_movement_change_available_for) || null,
      parseInt(pieceData.down_right_movement_change_available_for) || null,
      parseInt(pieceData.down_movement_change_available_for) || null,
      parseInt(pieceData.down_left_movement_change_available_for) || null,
      parseInt(pieceData.left_movement_change_available_for) || null,
      parseBooleanField(pieceData.repeating_movement_change),
      parseBooleanField(pieceData.require_empty_via_movement),
      // Direction change (capture)
      parseBooleanField(pieceData.directional_capture_change),
      parseInt(pieceData.up_left_capture_change) || 0,
      parseInt(pieceData.up_capture_change) || 0,
      parseInt(pieceData.up_right_capture_change) || 0,
      parseInt(pieceData.right_capture_change) || 0,
      parseInt(pieceData.down_right_capture_change) || 0,
      parseInt(pieceData.down_capture_change) || 0,
      parseInt(pieceData.down_left_capture_change) || 0,
      parseInt(pieceData.left_capture_change) || 0,
      pieceData.up_left_capture_change_exact === 'true' || pieceData.up_left_capture_change_exact === true,
      pieceData.up_capture_change_exact === 'true' || pieceData.up_capture_change_exact === true,
      pieceData.up_right_capture_change_exact === 'true' || pieceData.up_right_capture_change_exact === true,
      pieceData.right_capture_change_exact === 'true' || pieceData.right_capture_change_exact === true,
      pieceData.down_right_capture_change_exact === 'true' || pieceData.down_right_capture_change_exact === true,
      pieceData.down_capture_change_exact === 'true' || pieceData.down_capture_change_exact === true,
      pieceData.down_left_capture_change_exact === 'true' || pieceData.down_left_capture_change_exact === true,
      pieceData.left_capture_change_exact === 'true' || pieceData.left_capture_change_exact === true,
      parseInt(pieceData.up_left_capture_change_available_for) || null,
      parseInt(pieceData.up_capture_change_available_for) || null,
      parseInt(pieceData.up_right_capture_change_available_for) || null,
      parseInt(pieceData.right_capture_change_available_for) || null,
      parseInt(pieceData.down_right_capture_change_available_for) || null,
      parseInt(pieceData.down_capture_change_available_for) || null,
      parseInt(pieceData.down_left_capture_change_available_for) || null,
      parseInt(pieceData.left_capture_change_available_for) || null,
      parseBooleanField(pieceData.repeating_capture_change),
      parseBooleanField(pieceData.require_empty_via_capture),
      parseBooleanField(pieceData.require_direction_change),
      parseBooleanField(pieceData.require_direction_change_capture),
...
app.post("/api/physical-board-request", async (req, res) => {
  try {
    const {
      ...
      game_id, game_name, board_grid_width, board_grid_height,
      border_wood, light_square_wood, dark_square_wood,
      dimension_unit, board_length_dim, board_width_dim,
    } = req.body;
    ...
    // Persist the request to the database for admin review
    try {
      await db_pool.query(
        `INSERT INTO physical_board_requests
          (name, email, game_id, game_name, board_grid_width, board_grid_height,
           border_wood, light_square_wood, dark_square_wood,
           dimension_unit, board_length_dim, board_width_dim, message)
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
        [
          name, email,
          game_id ? parseInt(game_id, 10) : null,
          game_name || null,
          board_grid_width ? parseInt(board_grid_width, 10) : null,
          board_grid_height ? parseInt(board_grid_height, 10) : null,
          border_wood || null, light_square_wood || null, dark_square_wood || null,
          dimension_unit || null, board_length_dim || null, board_width_dim || null,
          message,
        ]
      );
    } catch (dbErr) {
...
app.get("/api/admin/physical-board-requests", authenticateAdmin, async (req, res) => {
  try {
    ...
    const [[{ total }]] = await db_pool.query(
      `SELECT COUNT(*) AS total FROM physical_board_requests ${where}`,
      params
    );
    const [rows] = await db_pool.query(
      `SELECT * FROM physical_board_requests ${where} ORDER BY created_at DESC LIMIT ? OFFSET ?`,
      [...params, limit, offset]
    );
    ...
    console.error('GET /api/admin/physical-board-requests error:', err);
    res.status(500).json({ error: 'Failed to fetch physical board requests' });
  }
});
...
app.patch("/api/admin/physical-board-requests/:id", authenticateAdmin, async (req, res) => {
  try {
    ...
    await db_pool.query(
      'UPDATE physical_board_requests SET status = ?, updated_at = NOW() WHERE id = ?',
      [status, id]
    );
    res.json({ message: 'Status updated' });
  } catch (err) {
    console.error('PATCH /api/admin/physical-board-requests error:', err);
...
app.delete("/api/admin/physical-board-requests/:id", authenticateAdmin, async (req, res) => {
  try {
    const id = parseInt(req.params.id, 10);
    await db_pool.query('DELETE FROM physical_board_requests WHERE id = ?', [id]);
    res.json({ message: 'Deleted' });
  } catch (err) {
