 ...
 */
const addPieceToGameType = async (gameTypeId, pieceId, x, y, playerNumber = 1, endsGameOnCheckmate = false, endsGameOnCapture = false, manualCastlingPartners = false, castlingPartnerLeftKey = null, castlingPartnerRightKey = null, canControlSquares = false, castlingDistance = 2, hitPoints = 1, attackDamage = 1, showHpAd = false, hpRegen = 0, cannotBeCaptured = false, showRegen = false, burnDamage = 0, burnDuration = 0, showBurn = false, trample = false, trampleRadius = 0, ghostwalk = false, dieOnCapture = false, attackRadius = 0, imageIndex = null, promotionPiecesOverride = null, canPromoteToCheckmate = false, limitPromoteCheckmateToOriginal = false, canPromoteToCapture = false, limitPromoteCaptureToOriginal = false, capturePointsGain = 0, capturePointsLoss = 0) => {
