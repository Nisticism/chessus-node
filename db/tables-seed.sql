...
CREATE TABLE IF NOT EXISTS game_types (
    ...
    range_squares_string MEDIUMTEXT,
    promotion_squares_string MEDIUMTEXT,
    special_squares_string MEDIUMTEXT,
    control_squares_string MEDIUMTEXT,
