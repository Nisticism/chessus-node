...
export const HUB_GENERAL_FORUMS = "HUB_GENERAL_FORUMS";
export const HUB_GAME_FORUMS = "HUB_GAME_FORUMS";
...
export const SET_PIECE_VALUE_CACHE = "SET_PIECE_VALUE_CACHE";
export const INVALIDATE_PIECE_VALUE_CACHE = "INVALIDATE_PIECE_VALUE_CACHE";
...
export const MARK_DM_READ = "MARK_DM_READ";
export const GET_UNREAD_DM_COUNT_SUCCESS = "GET_UNREAD_DM_COUNT_SUCCESS";

// Site Settings
export const FETCH_SITE_SETTINGS_SUCCESS = "FETCH_SITE_SETTINGS_SUCCESS";

// Lobby Games
export const SET_LOBBY_OPEN_GAMES = "SET_LOBBY_OPEN_GAMES";
export const SET_LOBBY_ONGOING_GAMES = "SET_LOBBY_ONGOING_GAMES";
export const SET_LOBBY_PRIVATE_GAMES = "SET_LOBBY_PRIVATE_GAMES";
export const SET_LOBBY_MY_BOT_GAMES = "SET_LOBBY_MY_BOT_GAMES";
export const ADD_LOBBY_OPEN_GAME = "ADD_LOBBY_OPEN_GAME";
export const REMOVE_LOBBY_OPEN_GAME = "REMOVE_LOBBY_OPEN_GAME";
export const REMOVE_LOBBY_GAME = "REMOVE_LOBBY_GAME";
export const LOBBY_GAME_STARTED = "LOBBY_GAME_STARTED";
