...
const changelogData = [
  {
    date: "April 27, 2026",
    title: "About Us via admin, AI training resume fix, AI trainer respects forced capture & stalemate rules, dev script auto-builds Rust, delete training jobs, global wipe, upload fix",
    items: [
