...
const changelogData = [
  {
    ...
    items: [
      ...
      "Admin dashboard — AI Training: per-game-type AI Analysis report. Admins can generate a balance summary (per-side win rate, draw type breakdown, sample size, and an overall imbalance verdict) for any trained game and publish it as private (admins only), creator-visible (game creator + admins), or public (shareable link). When you can view it, a '📊 AI Analysis' button appears next to Play on the game detail page",
